"""ConvexParametersScreen -- grouped-card parameter editor with dirty tracking and validation.
...
# external code that imports it — it always reflects the Convex defaults
# from machine_config._CONVEX_PARAM_DEFS.
# At runtime, ConvexParametersScreen uses mc.get_param_defs() to get the active type's defs.
...
class ConvexParametersScreen(BaseParametersScreen):
