...
from .flat_grind_widgets import (
    DeltaCBarChart,
    _BaseBarChart,
...
# ---------------------------------------------------------------------------
# Delta-C constants and DeltaCBarChart are imported from flat_grind_widgets.
...
# _BaseBarChart and DeltaCBarChart are now imported from flat_grind_widgets.
# BCompBarChart remains here — Serration-specific, deferred to Phase 21.
