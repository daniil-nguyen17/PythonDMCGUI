...
def test_stone_window_for_index_heel():
    ...
    from dmccodegui.screens.run import stone_window_for_index
...
def test_stone_window_always_correct_size():
    ...
    from dmccodegui.screens.run import stone_window_for_index, STONE_WINDOW_INDICES
...
def test_offsets_to_delta_c_uniform():
    ...
    from dmccodegui.screens.run import RunScreen, DELTA_C_ARRAY_SIZE
    r = RunScreen()
    r.section_count = 5
...
def test_delta_c_step_adjustment():
    ...
    os.environ.setdefault('KIVY_NO_ENV_CONFIG', '1')
    os.environ.setdefault('KIVY_LOG_LEVEL', 'critical')
    from dmccodegui.screens.run import RunScreen, DELTA_C_STEP
    r = RunScreen()
    r.section_count = 3
